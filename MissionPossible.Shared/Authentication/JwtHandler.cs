...
namespace MissionPossible.Shared.Authentication
{
    public class JwtHandler : IJwtHandler
    {
        private static readonly ISet<string> DefaultClaims = new HashSet<string>
        {
           ...
           "userType",
            //AutoNinjaClaimTypes.Email,
            //AutoNinjaClaimTypes.IsCompleted
        };
        ...
        public JsonWebToken CreateToken(string userId, string email ,string userType, IDictionary<string, string> claims = null)
        {
            ...
            var jwtClaims = new List<Claim>
            {
                ...
                //new Claim("isCompleted", isCompleted.ToString())
            };
