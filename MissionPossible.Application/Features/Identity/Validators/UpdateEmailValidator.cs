...
namespace MissionPossible.Application.Features.Identity.Validators
{
    public class UpdateEmailValidator : AbstractValidator<UpdateEmailCommand>
    {
        ...
        public UpdateEmailValidator(IUserRepository userRepository)
        {
        ...
        public override Task<ValidationResult> ValidateAsync(ValidationContext<UpdateEmailCommand> context, CancellationToken cancellation = default)
        {
